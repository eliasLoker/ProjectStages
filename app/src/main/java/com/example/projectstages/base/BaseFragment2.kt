...
abstract class BaseFragment2<
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        onEachViewState(viewModel.stateFlow)
        onEachViewEffect(viewModel.viewEffect)
    }
    ...
    private fun onEachViewState(viewStateFlow: Flow<ViewState?>) {
    ...
    private fun onEachViewEffect(viewEffectFlow: Flow<ViewEffect?>) {
