...
class AdapterStickyItemDecorator2(
...
//    private var header: TextView? = null
    ...
    override fun onDrawOver(c: Canvas, parent: RecyclerView, state: RecyclerView.State) {
        ...
        if (headerView == null) {
            headerView = inflateHeaderView(parent) as TextView
//            header = headerView!!.findViewById(R.id.list_item_section_text) as TextView
        ...
        for (i in 0 until parent.childCount) {
            ...
            val title: CharSequence = sectionCallback.getSectionHeader(position)
//            header!!.text = title
